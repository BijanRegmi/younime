...
const Section = (props: { animes: CardAnime[]; title: String }) => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-[repeat(auto-fill,24rem)] gap-x-4 gap-y-8 justify-center overflow-scroll h-full py-3 max-w-[149rem] border-b border-accent-300">
